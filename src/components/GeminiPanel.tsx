...
export function GrokIcon({ size = 13, color }: { size?: number; color?: string }) {
  // Official Grok mark (svgl.app). Single-color; theming via currentColor.
  const c = color ?? 'currentColor';
  return (
    <svg width={size} height={size} viewBox="0 0 1024 1024" fill={c} xmlns="http://www.w3.org/2000/svg">
